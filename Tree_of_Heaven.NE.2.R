...
toh.EDD <- read.csv('H:\\Shared drives\\Data\\Table\\USA\\Ailanthus.eddmaps.csv')[-which(is.na(toh.EDD$Longitude)),]
...
ras.set1 <- rasterize(x=toh.set1, y=envi.1k$CAN, fun='count', background=NA)
